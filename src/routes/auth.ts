...
import { complianceValidationSchema } from "../middleware/schema/complianceValidation";
...
auth_router.get("/general-links", generalController.getLinksData);

auth_router.get("/news-updates", generalController.newsUpdatesData);
...
// Generic dropdown
auth_router.get("/period-dropdown", generalController.getPeriodIdData);

auth_router.get("/mounth-data", generalController.getMounthData);
