...
-- 5. STAFF DO THE WORK SEND THIS TO ADMIN/REVIEWER STATUS CHANGED TO 'SUBMITTED'
-- 6. REVIEWER ACCEPT STATUS CHANGED TO 'VERIFIED'
-- 7. REVIEWER REJECT STATUS CHANGED TO 'REJECTED'
-- 8. ADMIN ACCEPT STATUS CHANGED TO 'COMPLETED'
-- 9. ADMIN REJECT STATUS CHANGED TO 'REJECTED'
